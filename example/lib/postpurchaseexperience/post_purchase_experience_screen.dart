...
class PostPurchaseExperienceScreen extends StatefulWidget {
  @override
  _PostPurchaseExperienceScreenState createState() =>
      _PostPurchaseExperienceScreenState();
}

class _PostPurchaseExperienceScreenState
    extends State<PostPurchaseExperienceScreen> {
  ...
  KlarnaPostPurchaseExperience ppe = new KlarnaPostPurchaseExperience();
  ...
  void ppeInitialize(BuildContext context) async {
    final KlarnaResult result = await ppe.initialize(
        "https://www.klarna.com", localeController.text, countryController.text,
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                border: InputBorder.none, labelText: 'Design'),
                          ),
